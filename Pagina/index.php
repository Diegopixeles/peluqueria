        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4 rounded-xl overflow-hidden">
                <div class="aspect-square overflow-hidden rounded-xl shadow-lg hover:opacity-75 transition duration-300 relative group">
                    <img src="./Imagenes/peinados/corte femenino.png" alt="Corte Femenino" class="object-cover w-full h-full">
                ...
                <div class="aspect-square overflow-hidden rounded-xl shadow-lg hover:opacity-75 transition duration-300 relative group">
                    <img src="./Imagenes/peinados/corte de barba.png" alt="Barbería Clásica" class="object-cover w-full h-full">
                    <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition flex items-center justify-center">
                ...
                <div class="aspect-square overflow-hidden rounded-xl shadow-lg hover:opacity-75 transition duration-300 relative group">
                    <img src="./Imagenes/peinados/decoloración.png" alt="Decoloraciones" class="object-cover w-full h-full">
                    <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition flex items-center justify-center">
                        <span class="text-white font-bold text-lg opacity-0 group-hover:opacity-100 transition drop-shadow-md">Decoloraciones</span>
                    </div>
                </div>
                <div class="aspect-square overflow-hidden rounded-xl shadow-lg hover:opacity-75 transition duration-300 relative group">
                    <img src="./Imagenes/peinados/de evento.png" alt="Peinado de Evento" class="object-cover w-full h-full">
                    <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition flex items-center justify-center">
                ...
                <div class="aspect-square overflow-hidden rounded-xl shadow-lg hover:opacity-75 transition duration-300 relative group">
                    <img src="./Imagenes/peinados/corte masculino.png" alt="Corte Masculino" class="object-cover w-full h-full">
                    <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition flex items-center justify-center">
                        <span class="text-white font-bold text-lg opacity-0 group-hover:opacity-100 transition drop-shadow-md">Corte Masculino</span>
                    </div>
                </div>
                <div class="aspect-square overflow-hidden rounded-xl shadow-lg hover:opacity-75 transition duration-300 relative group">
                    <img src="./Imagenes/peinados/trenzas.png" alt="Trenzas" class="object-cover w-full h-full">
                    <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition flex items-center justify-center">
